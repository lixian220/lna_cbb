 ...
 * 
 *      The name of the test suite is: Main.POWER_UP.GSID_SET_0_CHECK
 * 
...
spec Spec_1
{
    ...
    {
        transactSeq dsa_gen.Main.POWER_UP.GSID_SET_0_CHECK.TrSeq_1.TS_Setup1 _call_TS_Setup1_trSeq_1
        {
        }
    }
}

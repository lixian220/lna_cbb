 ...
 * 
 *      The name of the test suite is: Main.RF_FT.MB2_IN2_MHB3_OUT_B11_HG1_OPA
 * 
...
spec Gain_MUX_1
{
    ...
    action MB2_IN2_MHB3_OUT_B11_HG1_OPA_Stim_Gain_MUX;
    action MB2_IN2_MHB3_OUT_B11_HG1_OPA_Meas_Gain_MUX;
    ...
    setup rfStim aliasRF_Stim2
    {
        ...
        action cw MB2_IN2_MHB3_OUT_B11_HG1_OPA_Stim_Gain_MUX
        {
    ...
    setup rfMeas aliasRF_Meas1
    {
        ...
        action cwPower MB2_IN2_MHB3_OUT_B11_HG1_OPA_Meas_Gain_MUX
        {
            frequency = 1.4859 GHz;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.MB2_IN2_MHB3_OUT_B11_HG1_OPA.Gain_MUX_1.TS_Setup_Gain_MUX _call_TS_Setup_Gain_MUX_trSeq_1
        {
        }
    }
}

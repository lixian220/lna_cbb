 ...
 * 
 *      The name of the test suite is: Main.RF_FT.MB1_IN1_MHB1_OUT_B40_LP_OPA
 * 
...
spec IDD_Gain_MLP_IIP3_1
{
    ...
    action MB1_IN1_MHB1_OUT_B40_LP_OPA_Stim_IDD_Off;
    action MB1_IN1_MHB1_OUT_B40_LP_OPA_Meas_IDD;
    action MB1_IN1_MHB1_OUT_B40_LP_OPA_Stim_Gain_MLP;
    action MB1_IN1_MHB1_OUT_B40_LP_OPA_Meas_Gain_MLP;
    action MB1_IN1_MHB1_OUT_B40_LP_OPA_Stim_IIP3;
    action MB1_IN1_MHB1_OUT_B40_LP_OPA_Meas_IIP3_I2;
    transactSeq _call_TS_ReSet_IIP3_trSeq_2;
    action MB1_IN1_MHB1_OUT_B40_LP_OPA_Stim_IIP3_Off;
    ...
    setup rfStim aliasRF_Stim1
    {
        ...
        action cw MB1_IN1_MHB1_OUT_B40_LP_OPA_Stim_IDD_Off
        {
            frequency = 5.991 GHz;
            power = -110 dBm;
        }
    
        action cw MB1_IN1_MHB1_OUT_B40_LP_OPA_Stim_Gain_MLP
        {
            frequency = 2.35 GHz;
            power = -50 dBm;
        }
    
        action modulated MB1_IN1_MHB1_OUT_B40_LP_OPA_Stim_IIP3
        {
            frequency = 2.352 GHz;
            power = -30 dBm;
            waveformI = MB1_IN1_MHB1_OUT_B40_LP_OPA_Stim_IIP3;
            waveformQ = MB1_IN1_MHB1_OUT_B40_LP_OPA_Stim_IIP3;
            optimization = imd;
            repeatInfinite = true;
            basebandAttenuation = 3 dB;
        }
    
        action cw MB1_IN1_MHB1_OUT_B40_LP_OPA_Stim_IIP3_Off
        {
            frequency = 5.991 GHz;
            power = -110 dBm;
        }
    ...
    setup rfMeas aliasRF_Meas1
    {
        ...
        action cwPower MB1_IN1_MHB1_OUT_B40_LP_OPA_Meas_Gain_MLP
        {
            frequency = 2.35 GHz;
        ...
        action cwPower MB1_IN1_MHB1_OUT_B40_LP_OPA_Meas_IIP3_I2
        {
            frequency = 2.367 GHz;
            ifFrequency = 27.12311 MHz;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.MB1_IN1_MHB1_OUT_B40_LP_OPA.IDD_Gain_MLP_IIP3_1.TS_Setup_IDD _call_TS_Setup_IDD_trSeq_1
        {
        }
    }
    ...
    setup dcVI VDD1P8
    {
        action imeas MB1_IN1_MHB1_OUT_B40_LP_OPA_Meas_IDD
        {
            waitTime = 5.000 ms;
            irange = 30.00 mA;
            averages = 4;
    ...
    waveform sine MB1_IN1_MHB1_OUT_B40_LP_OPA_Stim_IIP3
    {
        amplitude = 1;
        frequency = 5 MHz;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.MB1_IN1_MHB1_OUT_B40_LP_OPA.IDD_Gain_MLP_IIP3_2.TS_ReSet_IIP3 _call_TS_ReSet_IIP3_trSeq_2
        {
        }
    }
}

 ...
 * 
 *      The name of the test suite is: Main.RF_FT.MB1_IN2_MHB1_OUT_B3_HG1_OPB
 * 
...
spec IDD_Gain_HG1_1
{
    ...
    action MB1_IN2_MHB1_OUT_B3_HG1_OPB_Stim_IDD_Off;
    action MB1_IN2_MHB1_OUT_B3_HG1_OPB_Meas_IDD;
    action MB1_IN2_MHB1_OUT_B3_HG1_OPB_Stim_Gain_HG1;
    action MB1_IN2_MHB1_OUT_B3_HG1_OPB_Meas_Gain_HG1;
    ...
    setup rfStim aliasRF_Stim1
    {
        ...
        action cw MB1_IN2_MHB1_OUT_B3_HG1_OPB_Stim_IDD_Off
        {
            frequency = 5.991 GHz;
            power = -110 dBm;
        }
    
        action cw MB1_IN2_MHB1_OUT_B3_HG1_OPB_Stim_Gain_HG1
        {
    ...
    setup rfMeas aliasRF_Meas1
    {
        ...
        action cwPower MB1_IN2_MHB1_OUT_B3_HG1_OPB_Meas_Gain_HG1
        {
            frequency = 1.8425 GHz;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.MB1_IN2_MHB1_OUT_B3_HG1_OPB.IDD_Gain_HG1_1.TS_Setup_IDD _call_TS_Setup_IDD_trSeq_1
        {
        }
    }
    ...
    setup dcVI VDD1P8
    {
        action imeas MB1_IN2_MHB1_OUT_B3_HG1_OPB_Meas_IDD
        {
            waitTime = 5.000 ms;
            irange = 30.00 mA;
            averages = 4;

 ...
 * 
 *      The name of the test suite is: Main.RF_FT.HB2_IN2_MHB2_OUT_B30_LP_OPA
 * 
...
spec IDD_Gain_MLP_IIP3_1
{
    ...
    action HB2_IN2_MHB2_OUT_B30_LP_OPA_Stim_IDD_Off;
    action HB2_IN2_MHB2_OUT_B30_LP_OPA_Meas_IDD;
    action HB2_IN2_MHB2_OUT_B30_LP_OPA_Stim_Gain_MLP;
    action HB2_IN2_MHB2_OUT_B30_LP_OPA_Meas_Gain_MLP;
    action HB2_IN2_MHB2_OUT_B30_LP_OPA_Stim_IIP3;
    action HB2_IN2_MHB2_OUT_B30_LP_OPA_Meas_IIP3_I2;
    transactSeq _call_TS_ReSet_IIP3_trSeq_2;
    action HB2_IN2_MHB2_OUT_B30_LP_OPA_Stim_IIP3_Off;
    ...
    setup rfStim aliasRF_Stim3
    {
        ...
        action cw HB2_IN2_MHB2_OUT_B30_LP_OPA_Stim_IDD_Off
        {
            frequency = 5.991 GHz;
            power = -110 dBm;
        }
    
        action cw HB2_IN2_MHB2_OUT_B30_LP_OPA_Stim_Gain_MLP
        {
            frequency = 2.355 GHz;
            power = -50 dBm;
        }
    
        action modulated HB2_IN2_MHB2_OUT_B30_LP_OPA_Stim_IIP3
        {
            frequency = 2.32125 GHz;
            power = -30 dBm;
            waveformI = HB2_IN2_MHB2_OUT_B30_LP_OPA_Stim_IIP3;
            waveformQ = HB2_IN2_MHB2_OUT_B30_LP_OPA_Stim_IIP3;
            optimization = imd;
            repeatInfinite = true;
            basebandAttenuation = 3 dB;
        }
    
        action cw HB2_IN2_MHB2_OUT_B30_LP_OPA_Stim_IIP3_Off
        {
            frequency = 5.991 GHz;
            power = -110 dBm;
        }
    ...
    setup rfMeas aliasRF_Meas1
    {
        ...
        action cwPower HB2_IN2_MHB2_OUT_B30_LP_OPA_Meas_Gain_MLP
        {
            frequency = 2.355 GHz;
        ...
        action cwPower HB2_IN2_MHB2_OUT_B30_LP_OPA_Meas_IIP3_I2
        {
            frequency = 2.355 GHz;
            ifFrequency = 27.12311 MHz;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.HB2_IN2_MHB2_OUT_B30_LP_OPA.IDD_Gain_MLP_IIP3_1.TS_Setup_IDD _call_TS_Setup_IDD_trSeq_1
        {
        }
    }
    ...
    setup dcVI VDD1P8
    {
        action imeas HB2_IN2_MHB2_OUT_B30_LP_OPA_Meas_IDD
        {
            waitTime = 5.000 ms;
            irange = 30.00 mA;
            averages = 4;
    ...
    waveform sine HB2_IN2_MHB2_OUT_B30_LP_OPA_Stim_IIP3
    {
        amplitude = 1;
        frequency = 11.25 MHz;

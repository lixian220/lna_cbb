 ...
 * 
 *      The name of the test suite is: Main.RF_FT.MB1_IN2_MHB3_OUT_B3_HG1_OPA
 * 
...
spec Gain_MUX_1
{
    ...
    action MB1_IN2_MHB3_OUT_B3_HG1_OPA_Stim_Gain_MUX;
    action MB1_IN2_MHB3_OUT_B3_HG1_OPA_Meas_Gain_MUX;
    ...
    setup rfStim aliasRF_Stim1
    {
        ...
        action cw MB1_IN2_MHB3_OUT_B3_HG1_OPA_Stim_Gain_MUX
        {
    ...
    setup rfMeas aliasRF_Meas1
    {
        ...
        action cwPower MB1_IN2_MHB3_OUT_B3_HG1_OPA_Meas_Gain_MUX
        {
            frequency = 1.8425 GHz;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.MB1_IN2_MHB3_OUT_B3_HG1_OPA.Gain_MUX_1.TS_Setup_Gain_MUX _call_TS_Setup_Gain_MUX_trSeq_1
        {
        }
    }
}

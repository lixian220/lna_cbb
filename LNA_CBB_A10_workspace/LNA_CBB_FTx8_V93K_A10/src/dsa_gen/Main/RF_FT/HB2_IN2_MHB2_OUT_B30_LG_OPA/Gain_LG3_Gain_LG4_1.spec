 ...
 * 
 *      The name of the test suite is: Main.RF_FT.HB2_IN2_MHB2_OUT_B30_LG_OPA
 * 
...
spec Gain_LG3_Gain_LG4_1
{
    ...
    action HB2_IN2_MHB2_OUT_B30_LG_OPA_Stim_Gain_LG3;
    action HB2_IN2_MHB2_OUT_B30_LG_OPA_Meas_Gain_LG3;
    transactSeq _call_TS_Setup_Gain_LG4_trSeq_2;
    action HB2_IN2_MHB2_OUT_B30_LG_OPA_Stim_Gain_LG4;
    action HB2_IN2_MHB2_OUT_B30_LG_OPA_Meas_Gain_LG4;
    ...
    setup rfStim aliasRF_Stim3
    {
        ...
        action cw HB2_IN2_MHB2_OUT_B30_LG_OPA_Stim_Gain_LG3
        {
            frequency = 2.355 GHz;
            power = -30 dBm;
        }
    
        action cw HB2_IN2_MHB2_OUT_B30_LG_OPA_Stim_Gain_LG4
        {
            frequency = 2.355 GHz;
            power = -30 dBm;
        }
    ...
    setup rfMeas aliasRF_Meas1
    {
        ...
        action cwPower HB2_IN2_MHB2_OUT_B30_LG_OPA_Meas_Gain_LG3
        {
            frequency = 2.355 GHz;
        ...
        action cwPower HB2_IN2_MHB2_OUT_B30_LG_OPA_Meas_Gain_LG4
        {
            frequency = 2.355 GHz;
            ifFrequency = 27.12311 MHz;
            expectedMaxPower = -20 dBm;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.HB2_IN2_MHB2_OUT_B30_LG_OPA.Gain_LG3_Gain_LG4_1.TS_Setup_Gain_LG3 _call_TS_Setup_Gain_LG3_trSeq_1
        {
        }
    }
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.HB2_IN2_MHB2_OUT_B30_LG_OPA.Gain_LG3_Gain_LG4_2.TS_Setup_Gain_LG4 _call_TS_Setup_Gain_LG4_trSeq_2
        {
        }
    }
}

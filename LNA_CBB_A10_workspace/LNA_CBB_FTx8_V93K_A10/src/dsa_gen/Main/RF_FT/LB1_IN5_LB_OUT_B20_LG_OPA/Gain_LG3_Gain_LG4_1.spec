 ...
 * 
 *      The name of the test suite is: Main.RF_FT.LB1_IN5_LB_OUT_B20_LG_OPA
 * 
...
spec Gain_LG3_Gain_LG4_1
{
    ...
    action LB1_IN5_LB_OUT_B20_LG_OPA_Stim_Gain_LG3;
    action LB1_IN5_LB_OUT_B20_LG_OPA_Meas_Gain_LG3;
    transactSeq _call_TS_Setup_Gain_LG4_trSeq_2;
    action LB1_IN5_LB_OUT_B20_LG_OPA_Stim_Gain_LG4;
    action LB1_IN5_LB_OUT_B20_LG_OPA_Meas_Gain_LG4;
    ...
    setup rfStim aliasRF_Stim1
    {
        ...
        action cw LB1_IN5_LB_OUT_B20_LG_OPA_Stim_Gain_LG3
        {
            frequency = 806 MHz;
            power = -30 dBm;
        }
    
        action cw LB1_IN5_LB_OUT_B20_LG_OPA_Stim_Gain_LG4
        {
            frequency = 806 MHz;
            power = -30 dBm;
        }
    ...
    setup rfMeas aliasRF_Meas1
    {
        ...
        action cwPower LB1_IN5_LB_OUT_B20_LG_OPA_Meas_Gain_LG3
        {
            frequency = 806 MHz;
        ...
        action cwPower LB1_IN5_LB_OUT_B20_LG_OPA_Meas_Gain_LG4
        {
            frequency = 806 MHz;
            ifFrequency = 27.12311 MHz;
            expectedMaxPower = -20 dBm;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.LB1_IN5_LB_OUT_B20_LG_OPA.Gain_LG3_Gain_LG4_1.TS_Setup_Gain_LG3 _call_TS_Setup_Gain_LG3_trSeq_1
        {
        }
    }
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.LB1_IN5_LB_OUT_B20_LG_OPA.Gain_LG3_Gain_LG4_2.TS_Setup_Gain_LG4 _call_TS_Setup_Gain_LG4_trSeq_2
        {
        }
    }
}

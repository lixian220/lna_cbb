 ...
 * 
 *      The name of the test suite is: Main.RF_FT.MB2_IN1_MHB2_OUT_B2_LP_OPA
 * 
...
spec IDD_Gain_MLP_IIP3_1
{
    ...
    action MB2_IN1_MHB2_OUT_B2_LP_OPA_Stim_IDD_Off;
    action MB2_IN1_MHB2_OUT_B2_LP_OPA_Meas_IDD;
    action MB2_IN1_MHB2_OUT_B2_LP_OPA_Stim_Gain_MLP;
    action MB2_IN1_MHB2_OUT_B2_LP_OPA_Meas_Gain_MLP;
    action MB2_IN1_MHB2_OUT_B2_LP_OPA_Stim_IIP3;
    action MB2_IN1_MHB2_OUT_B2_LP_OPA_Meas_IIP3_I2;
    transactSeq _call_TS_ReSet_IIP3_trSeq_2;
    action MB2_IN1_MHB2_OUT_B2_LP_OPA_Stim_IIP3_Off;
    ...
    setup rfStim aliasRF_Stim2
    {
        ...
        action cw MB2_IN1_MHB2_OUT_B2_LP_OPA_Stim_IDD_Off
        {
            frequency = 5.991 GHz;
            power = -110 dBm;
        }
    
        action cw MB2_IN1_MHB2_OUT_B2_LP_OPA_Stim_Gain_MLP
        {
            frequency = 1.96 GHz;
            power = -50 dBm;
        }
    
        action modulated MB2_IN1_MHB2_OUT_B2_LP_OPA_Stim_IIP3
        {
            frequency = 1.9 GHz;
            power = -30 dBm;
            waveformI = MB2_IN1_MHB2_OUT_B2_LP_OPA_Stim_IIP3;
            waveformQ = MB2_IN1_MHB2_OUT_B2_LP_OPA_Stim_IIP3;
            optimization = imd;
            repeatInfinite = true;
            basebandAttenuation = 3 dB;
        }
    
        action cw MB2_IN1_MHB2_OUT_B2_LP_OPA_Stim_IIP3_Off
        {
            frequency = 5.991 GHz;
            power = -110 dBm;
        }
    ...
    setup rfMeas aliasRF_Meas1
    {
        ...
        action cwPower MB2_IN1_MHB2_OUT_B2_LP_OPA_Meas_Gain_MLP
        {
            frequency = 1.96 GHz;
        ...
        action cwPower MB2_IN1_MHB2_OUT_B2_LP_OPA_Meas_IIP3_I2
        {
            frequency = 1.96 GHz;
            ifFrequency = 27.12311 MHz;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.MB2_IN1_MHB2_OUT_B2_LP_OPA.IDD_Gain_MLP_IIP3_1.TS_Setup_IDD _call_TS_Setup_IDD_trSeq_1
        {
        }
    }
    ...
    setup dcVI VDD1P8
    {
        action imeas MB2_IN1_MHB2_OUT_B2_LP_OPA_Meas_IDD
        {
            waitTime = 5.000 ms;
            irange = 30.00 mA;
            averages = 4;
    ...
    waveform sine MB2_IN1_MHB2_OUT_B2_LP_OPA_Stim_IIP3
    {
        amplitude = 1;
        frequency = 20 MHz;

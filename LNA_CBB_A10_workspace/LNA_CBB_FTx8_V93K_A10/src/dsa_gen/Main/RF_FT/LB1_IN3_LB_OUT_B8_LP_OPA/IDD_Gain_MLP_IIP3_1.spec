 ...
 * 
 *      The name of the test suite is: Main.RF_FT.LB1_IN3_LB_OUT_B8_LP_OPA
 * 
...
spec IDD_Gain_MLP_IIP3_1
{
    ...
    action LB1_IN3_LB_OUT_B8_LP_OPA_Stim_IDD_Off;
    action LB1_IN3_LB_OUT_B8_LP_OPA_Meas_IDD;
    action LB1_IN3_LB_OUT_B8_LP_OPA_Stim_Gain_MLP;
    action LB1_IN3_LB_OUT_B8_LP_OPA_Meas_Gain_MLP;
    action LB1_IN3_LB_OUT_B8_LP_OPA_Stim_IIP3;
    action LB1_IN3_LB_OUT_B8_LP_OPA_Meas_IIP3_I2;
    transactSeq _call_TS_ReSet_IIP3_trSeq_2;
    action LB1_IN3_LB_OUT_B8_LP_OPA_Stim_IIP3_Off;
    ...
    setup rfStim aliasRF_Stim1
    {
        ...
        action cw LB1_IN3_LB_OUT_B8_LP_OPA_Stim_IDD_Off
        {
            frequency = 5.991 GHz;
            power = -110 dBm;
        }
    
        action cw LB1_IN3_LB_OUT_B8_LP_OPA_Stim_Gain_MLP
        {
            frequency = 942.5 MHz;
            power = -50 dBm;
        }
    
        action modulated LB1_IN3_LB_OUT_B8_LP_OPA_Stim_IIP3
        {
            frequency = 908.75 MHz;
            power = -30 dBm;
            waveformI = LB1_IN3_LB_OUT_B8_LP_OPA_Stim_IIP3;
            waveformQ = LB1_IN3_LB_OUT_B8_LP_OPA_Stim_IIP3;
            optimization = imd;
            repeatInfinite = true;
            basebandAttenuation = 3 dB;
        }
    
        action cw LB1_IN3_LB_OUT_B8_LP_OPA_Stim_IIP3_Off
        {
            frequency = 5.991 GHz;
            power = -110 dBm;
        }
    ...
    setup rfMeas aliasRF_Meas1
    {
        ...
        action cwPower LB1_IN3_LB_OUT_B8_LP_OPA_Meas_Gain_MLP
        {
            frequency = 942.5 MHz;
        ...
        action cwPower LB1_IN3_LB_OUT_B8_LP_OPA_Meas_IIP3_I2
        {
            frequency = 942.5 MHz;
            ifFrequency = 27.12311 MHz;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.LB1_IN3_LB_OUT_B8_LP_OPA.IDD_Gain_MLP_IIP3_1.TS_Setup_IDD _call_TS_Setup_IDD_trSeq_1
        {
        }
    }
    ...
    setup dcVI VDD1P8
    {
        action imeas LB1_IN3_LB_OUT_B8_LP_OPA_Meas_IDD
        {
            waitTime = 5.000 ms;
            irange = 30.00 mA;
            averages = 4;
    ...
    waveform sine LB1_IN3_LB_OUT_B8_LP_OPA_Stim_IIP3
    {
        amplitude = 1;
        frequency = 11.25 MHz;

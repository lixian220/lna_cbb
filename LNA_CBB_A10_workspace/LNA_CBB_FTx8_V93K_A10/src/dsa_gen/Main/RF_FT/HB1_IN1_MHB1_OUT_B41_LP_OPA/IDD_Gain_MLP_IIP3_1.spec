 ...
 * 
 *      The name of the test suite is: Main.RF_FT.HB1_IN1_MHB1_OUT_B41_LP_OPA
 * 
...
spec IDD_Gain_MLP_IIP3_1
{
    ...
    action HB1_IN1_MHB1_OUT_B41_LP_OPA_Stim_IDD_Off;
    action HB1_IN1_MHB1_OUT_B41_LP_OPA_Meas_IDD;
    action HB1_IN1_MHB1_OUT_B41_LP_OPA_Stim_Gain_MLP;
    action HB1_IN1_MHB1_OUT_B41_LP_OPA_Meas_Gain_MLP;
    action HB1_IN1_MHB1_OUT_B41_LP_OPA_Stim_IIP3;
    action HB1_IN1_MHB1_OUT_B41_LP_OPA_Meas_IIP3_I2;
    transactSeq _call_TS_ReSet_IIP3_trSeq_2;
    action HB1_IN1_MHB1_OUT_B41_LP_OPA_Stim_IIP3_Off;
    ...
    setup rfStim aliasRF_Stim2
    {
        ...
        action cw HB1_IN1_MHB1_OUT_B41_LP_OPA_Stim_IDD_Off
        {
            frequency = 5.991 GHz;
            power = -110 dBm;
        }
    
        action cw HB1_IN1_MHB1_OUT_B41_LP_OPA_Stim_Gain_MLP
        {
            frequency = 2.593 GHz;
            power = -50 dBm;
        }
    
        action modulated HB1_IN1_MHB1_OUT_B41_LP_OPA_Stim_IIP3
        {
            frequency = 2.595 GHz;
            power = -30 dBm;
            waveformI = HB1_IN1_MHB1_OUT_B41_LP_OPA_Stim_IIP3;
            waveformQ = HB1_IN1_MHB1_OUT_B41_LP_OPA_Stim_IIP3;
            optimization = imd;
            repeatInfinite = true;
            basebandAttenuation = 3 dB;
        }
    
        action cw HB1_IN1_MHB1_OUT_B41_LP_OPA_Stim_IIP3_Off
        {
            frequency = 5.991 GHz;
            power = -110 dBm;
        }
    ...
    setup rfMeas aliasRF_Meas1
    {
        ...
        action cwPower HB1_IN1_MHB1_OUT_B41_LP_OPA_Meas_Gain_MLP
        {
            frequency = 2.593 GHz;
        ...
        action cwPower HB1_IN1_MHB1_OUT_B41_LP_OPA_Meas_IIP3_I2
        {
            frequency = 2.61 GHz;
            ifFrequency = 27.12311 MHz;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.HB1_IN1_MHB1_OUT_B41_LP_OPA.IDD_Gain_MLP_IIP3_1.TS_Setup_IDD _call_TS_Setup_IDD_trSeq_1
        {
        }
    }
    ...
    setup dcVI VDD1P8
    {
        action imeas HB1_IN1_MHB1_OUT_B41_LP_OPA_Meas_IDD
        {
            waitTime = 5.000 ms;
            irange = 30.00 mA;
            averages = 4;
    ...
    waveform sine HB1_IN1_MHB1_OUT_B41_LP_OPA_Stim_IIP3
    {
        amplitude = 1;
        frequency = 5 MHz;

 ...
 * 
 *      The name of the test suite is: Main.RF_FT.HB1_IN2_MHB1_OUT_B40_HG1_OPB
 * 
...
spec IDD_Gain_HG1_1
{
    ...
    action HB1_IN2_MHB1_OUT_B40_HG1_OPB_Stim_IDD_Off;
    action HB1_IN2_MHB1_OUT_B40_HG1_OPB_Meas_IDD;
    action HB1_IN2_MHB1_OUT_B40_HG1_OPB_Stim_Gain_HG1;
    action HB1_IN2_MHB1_OUT_B40_HG1_OPB_Meas_Gain_HG1;
    ...
    setup rfStim aliasRF_Stim2
    {
        ...
        action cw HB1_IN2_MHB1_OUT_B40_HG1_OPB_Stim_IDD_Off
        {
            frequency = 5.991 GHz;
            power = -110 dBm;
        }
    
        action cw HB1_IN2_MHB1_OUT_B40_HG1_OPB_Stim_Gain_HG1
        {
            frequency = 2.35 GHz;
            power = -50 dBm;
        }
    ...
    setup rfMeas aliasRF_Meas1
    {
        ...
        action cwPower HB1_IN2_MHB1_OUT_B40_HG1_OPB_Meas_Gain_HG1
        {
            frequency = 2.35 GHz;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.HB1_IN2_MHB1_OUT_B40_HG1_OPB.IDD_Gain_HG1_1.TS_Setup_IDD _call_TS_Setup_IDD_trSeq_1
        {
        }
    }
    ...
    setup dcVI VDD1P8
    {
        action imeas HB1_IN2_MHB1_OUT_B40_HG1_OPB_Meas_IDD
        {
            waitTime = 5.000 ms;
            irange = 30.00 mA;
            averages = 4;

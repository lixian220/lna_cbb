 ...
 * 
 *      The name of the test suite is: Main.RF_FT.HB2_IN2_MHB3_OUT_B30_HG1_OPA
 * 
...
spec Gain_MUX_1
{
    ...
    action HB2_IN2_MHB3_OUT_B30_HG1_OPA_Stim_Gain_MUX;
    action HB2_IN2_MHB3_OUT_B30_HG1_OPA_Meas_Gain_MUX;
    ...
    setup rfStim aliasRF_Stim3
    {
        ...
        action cw HB2_IN2_MHB3_OUT_B30_HG1_OPA_Stim_Gain_MUX
        {
            frequency = 2.355 GHz;
            power = -50 dBm;
        }
    ...
    setup rfMeas aliasRF_Meas1
    {
        ...
        action cwPower HB2_IN2_MHB3_OUT_B30_HG1_OPA_Meas_Gain_MUX
        {
            frequency = 2.355 GHz;
    ...
    {
        transactSeq dsa_gen.Main.RF_FT.HB2_IN2_MHB3_OUT_B30_HG1_OPA.Gain_MUX_1.TS_Setup_Gain_MUX _call_TS_Setup_Gain_MUX_trSeq_1
        {
        }
    }
}

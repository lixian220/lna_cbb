 ...
 * 
 *      The name of the test suite is: Main.OS.OS_VDD_Open_PPMU
 * 
...
spec Spec_1
{
    action OS_VDD_serial_SDATA;
    action OS_VDD_serial_reset_SDATA;
    action OS_VDD_serial_SCLK;
    action OS_VDD_serial_reset_SCLK;
    action OS_VDD_serial_USID0;
    action OS_VDD_serial_reset_USID0;
    action OS_VDD_serial_ATEST;
    action OS_VDD_serial_reset_ATEST;
    ...
    setup dcVI SDATA
    {
        action iforceVmeas OS_VDD_serial_SDATA
        {
        ...
        action vforce OS_VDD_serial_reset_SDATA
        {
            forceValue = 0 V;
        }
    }
    ...
    setup dcVI SCLK
    {
        action iforceVmeas OS_VDD_serial_SCLK
        {
            forceValue = 10.00000 uA;
            irange = 10.00000 uA;
            waitTime = 5.000 ms;
        ...
        action vforce OS_VDD_serial_reset_SCLK
        {
            forceValue = 0 V;
        }
    }
    ...
    setup dcVI USID0
    {
        action iforceVmeas OS_VDD_serial_USID0
        {
            forceValue = 10.00000 uA;
            irange = 10.00000 uA;
            waitTime = 5.000 ms;
        ...
        action vforce OS_VDD_serial_reset_USID0
        {
            forceValue = 0 V;
        }
    }
    ...
    setup dcVI ATEST
    {
        action iforceVmeas OS_VDD_serial_ATEST
        {
            forceValue = 10.00000 uA;
            irange = 10.00000 uA;
            waitTime = 5.000 ms;
        ...
        action vforce OS_VDD_serial_reset_ATEST
        {
            forceValue = 0 V;
        }
    }

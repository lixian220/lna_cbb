 ...
 *      src/rfcbb_tml/Functional_Test.java:67
 * 
 *   2. The testflow file which contains the used test suite and parameter
 *      settings:
 *      LNA/testflows/DFT.flow
 * 
 *      The name of the test suite is: Main.DFT.DFT_usid_prg_test_000
 * 
 ...
 *
 * ---------------------------------------------------------------------------*/
import setups.specs.DFT.DFT_spec_LNA_F4;

spec DFT_usid_prg_test_000_1
{
}

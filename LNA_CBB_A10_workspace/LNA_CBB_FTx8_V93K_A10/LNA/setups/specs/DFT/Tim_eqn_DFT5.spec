...
spec Tim_eqn_DFT5 {
  ...
  setup digInOut SDATA {
    set timing timingSet_1_EQNSET1 {
      ...
      r1 = 0.0 * per_9_616_eqn1+ roff-1.09*per_9_616_eqn1;  // 0.80
      r2 = 0.278 / (T_per) * per_9_616_eqn1+ roff-1.09*per_9_616_eqn1;
      r3 = 0.984 / (T_per) * per_9_616_eqn1+ roff-1.09*per_9_616_eqn1;
      r4 = 9.398 / (T_per) * per_9_616_eqn1+ roff-1.09*per_9_616_eqn1;
    }
  }

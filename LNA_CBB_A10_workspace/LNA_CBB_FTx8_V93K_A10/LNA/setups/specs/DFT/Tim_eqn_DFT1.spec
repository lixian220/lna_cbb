...
spec Tim_eqn_DFT1 {
  ...
  setup digInOut SCLK {
    set timing timingSet_1_EQNSET1 {
      ...
      d2 = 1.0 / T_per * per_9_616_eqn1;
      d3 = 5.77 / T_per * per_9_616_eqn1;
    }
  }
  setup digInOut SDATA {
    set timing timingSet_1_EQNSET1 {
      ...
      r1 = 0.0 * per_9_616_eqn1+ roff-1.11*per_9_616_eqn1;  // 0.82
      r2 = 0.278 / (T_per) * per_9_616_eqn1+ roff-1.11*per_9_616_eqn1;
      r3 = 0.984 / (T_per) * per_9_616_eqn1+ roff-1.11*per_9_616_eqn1;
      r4 = 9.398 / (T_per) * per_9_616_eqn1+ roff-1.11*per_9_616_eqn1;
    }
  }
